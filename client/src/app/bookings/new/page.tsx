...
export default function NewBookingPage() {
    ...
    const handleBooking = async () => {
        ...
        try {
            ...
            startTime.setHours(parseInt(selectedTime.split(':')[0]));
            startTime.setMinutes(parseInt(selectedTime.split(':')[1]));
                                ...
                                <div className="p-6 bg-emerald-900 text-white rounded-[32px] relative overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-4xl font-black">${(station.pricePerKwh * (duration/10)).toFixed(2)}</p>
                                        </div>
